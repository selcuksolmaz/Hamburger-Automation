...
namespace Proje
{
    public partial class PersonelKaydı : Form
    {
        ...
        {
            string kullaniciadı = textBox4.Text;
            string eposta = textBox5.Text;
            ...
            else
            {
                ...
                cmd2.Connection = con;
                cmd2.CommandText= "SELECT * FROM kullanici where k_ad='" + textBox4.Text + "' AND Eposta='" + textBox5.Text + "'";
                ...
                else
                {
                    ...
                    MessageBox.Show("Kullancı Adı veya Eposta önceden alınmıştır. Lütfen farklı bir Kullanıcı Adı veya Eposta alın!");
                    textBox1.Clear();
                    textBox2.Clear();
                    textBox3.Clear();
                    textBox4.Clear();
